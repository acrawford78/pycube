...
class Screen (object):
	...
	self.j = pygame.display.set_caption('Cube Demo')
...
class Cube (object):
    ...
    def sides(self):
        ...
        sides = [ Side( a, b, c, d, frontback)   #  front
                , Side( e, f, g, h, frontback)   #  back
                , Side( a, e, f, b, topbot)      #  bottom
                , Side( b, f, g, c, leftright)   # right
                , Side( c, g, h, d, topbot)      # top
                , Side( d, h, e, a, leftright)   # left
                ]
        return sides
